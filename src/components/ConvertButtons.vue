...
<template>
  <div class="grid grid-cols-2 gap-4" role="group" :aria-label="t('buttons.conversionOptions')">
    <button
      @click="handleSelectFile"
      :disabled="disabled || isSelectingFile || isSelectingFolder"
      class="flex flex-col items-center justify-center gap-2 p-6 bg-gradient-to-br from-green-500 to-emerald-600 text-white rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2"
      :aria-label="t('buttons.convertFile')"
    ...
    <button
      ...
      :disabled="disabled || isSelectingFile || isSelectingFolder"
      class="flex flex-col items-center justify-center gap-2 p-6 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-xl shadow-lg hover:shadow-xl hover:scale-[1.02] transition-all disabled:opacity-50 disabled:hover:scale-100 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
      :aria-label="t('buttons.convertFolder')"
